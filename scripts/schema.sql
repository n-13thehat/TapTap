...
-- CreateTable
CREATE TABLE "ExternalLibraryItem" (
    "id" UUID NOT NULL,
    "userId" UUID NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ExternalLibraryItem_userId_provider_externalId_key" ON "ExternalLibraryItem"("userId", "provider", "externalId");
...
-- CreateIndex
CREATE INDEX "ExchangeRate_quote_idx" ON "ExchangeRate"("quote");
